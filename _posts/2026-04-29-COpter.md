...
1. small change to the input problem -> require reconstructing solver-specific problem representations = significant setup cost for even the smallest change
...
## Goal
Continual optimization: provide both low dynamic regret and runtimes that scale favorably with the amount of change in the optimal solution over time, especially for slowly evolving resource-allocation problems that are the focus of this paper.
